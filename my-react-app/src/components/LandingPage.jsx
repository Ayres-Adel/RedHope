...
export default function LandingPage() {
  ...
  return (
    <>
      {/* Add ScrollProgress outside the section for better visibility */}
      <ScrollProgress />

      {/* Use a div wrapper instead of section to better control overflow */}
      <div className="homepage">
        <Navbar />

        {/* Home section with proper ID */}
        <div id="home" className="section-anchor"></div>
        <FadeInSection className="Container_01">
          <img
            src={Percentages}
            className="img_undraw_medicine"
            alt="Data Trends"
          />
          <div>
            <h1>
        ...
        <FadeInSection className="Container_02">
          <div className="stat">
            <h1>50+</h1>
            <p>
              {language === "fr" ? "Donneurs à proximité" : "Donors Nearby"}
            </p>
          </div>
          <div className="stat">
            <h1>100+</h1>
        ...
        <FadeInSection className="Container_03">
          ...
          <div className="flex_Container_03">
            ...
            <div className="card">
              ...
              <h2>
                {language === "fr" ? "Planifiez un don" : "Schedule a Donation"}
              </h2>
              <p>
                {language === "fr"
            ...
            <div className="card">
              ...
              <h2>{language === "fr" ? "Sauvez des vies" : "Save Lives"}</h2>
              <p>
                {language === "fr"
